...
namespace Curie
{
    public static class Utilities
    {
        ...
        public static Rect EnsureVisible(Rect pos, float min)
        {
		...
		public static Rect EnsureVisible(Rect pos)
		{
			return EnsureVisible(pos, 16.0f);
		}
        ...
        {
            if (File.Exists<T>(filename,null))
            {
                var bytes = File.ReadAllBytes<T>(filename,null);
        ...
        public static string FormatTime(double value, int numDecimals)
        {
        ...
        public static string FormatValue(double value, int numDecimals)
        {
            string sign = "";
            if (value < 0.0)
            {
